...
local placeScripts = {
    ...
    [92416421522960] = { script_id = "fe8a387692b9299230dcf43703ed1c85"},
...
local CONFIG = {
    ...
    KeyLink       = "https://ads.luarmor.net/get_key?for=MidNight_Hub__Key_System-dLnyEopHPYsm",
...
local Arqel = loadstring(game:HttpGet("https://raw.githubusercontent.com/Dev-pocoyoJS/Libkey/refs/heads/main/ArqelUi.luau"))()
